        ...
        if (nodeClass != null && !nodeClass.match(/collapsable/)) {
            ...
            if (ulNode != undefined) {
                if (ulNode.hasAttribute("style")) {
                    ulNode.setAttribute("style", "display: block; background-color: #FFFFFF; border-top: 1px dotted #A76040; border-bottom: 1px dotted #A76040; color: #A76040;  !important;");
                } else {
                    var ulStyle = document.createAttribute("style");
                    ulStyle.nodeValue = "display: block; background-color: #FFFFFF !important;";
